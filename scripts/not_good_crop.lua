-- this uses easycrop and its like 7years old 
-- see this link https://github.com/aidanholm/mpv-easycrop/blob/master/easycrop.lua
-- it lags also, so pkp switch to new one,
